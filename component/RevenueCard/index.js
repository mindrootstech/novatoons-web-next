...
const RevenueCard = ({ loadmore, transaction, loading }) => {
                ...
                <Row>
                  ...
                  <Col md={6}>
                    <div className='cardDetails'>
                      <h5>{item.type === "Unique Read Views" ? item.type : item.name}</h5>
                  ...
                  <Col md={4} className='amountPaidSection'>
                    <div className='paidAmount'> Amount Paid: <span>{
                    // (item.total_credits).toFixed(2)} CR /
                     (item.total_cost).toFixed(2)} USD
                    </span></div>
                  </Col>
                </Row>
              </div>
